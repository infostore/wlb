...
public class MilestoneResourceIT {
    ...
    private static final MilestoneStatus DEFAULT_MILESTONE_STATUS = MilestoneStatus.NEW;
    private static final MilestoneStatus UPDATED_MILESTONE_STATUS = MilestoneStatus.OPEN;
