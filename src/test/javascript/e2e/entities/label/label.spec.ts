...
describe('Label e2e test', () => {
  ...
  it('should load Labels', async () => {
    ...
    expect(await labelComponentsPage.getTitle()).to.eq('wlbApp.label.home.title');
  ...
  it('should load create Label page', async () => {
    ...
    expect(await labelUpdatePage.getPageTitle()).to.eq('wlbApp.label.home.createOrEditLabel');
  ...
  it('should create and save Labels', async () => {
    ...
    await promise.all([labelUpdatePage.setNameInput('name'), labelUpdatePage.labelGroupSelectLastOption()]);

    expect(await labelUpdatePage.getNameInput()).to.eq('name', 'Expected Name value to be equals to name');
  ...
  it('should delete last Label', async () => {
    ...
    expect(await labelDeleteDialog.getDialogTitle()).to.eq('wlbApp.label.delete.question');
