...
describe('Project e2e test', () => {
  ...
  it('should load Projects', async () => {
    ...
    expect(await projectComponentsPage.getTitle()).to.eq('wlbApp.project.home.title');
  ...
  it('should load create Project page', async () => {
    ...
    expect(await projectUpdatePage.getPageTitle()).to.eq('wlbApp.project.home.createOrEditLabel');
  ...
  it('should create and save Projects', async () => {
    ...
    await promise.all([projectUpdatePage.setNameInput('name'), projectUpdatePage.setDescriptionInput('description')]);
  ...
  it('should delete last Project', async () => {
    ...
    expect(await projectDeleteDialog.getDialogTitle()).to.eq('wlbApp.project.delete.question');
