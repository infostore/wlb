...
describe('Comment e2e test', () => {
  ...
  it('should load Comments', async () => {
    ...
    expect(await commentComponentsPage.getTitle()).to.eq('wlbApp.comment.home.title');
  ...
  it('should load create Comment page', async () => {
    ...
    expect(await commentUpdatePage.getPageTitle()).to.eq('wlbApp.comment.home.createOrEditLabel');
  ...
  it('should create and save Comments', async () => {
    ...
    await promise.all([commentUpdatePage.setDescriptionInput('description'), commentUpdatePage.issueSelectLastOption()]);

    expect(await commentUpdatePage.getDescriptionInput()).to.eq('description', 'Expected Description value to be equals to description');
  ...
  it('should delete last Comment', async () => {
    ...
    expect(await commentDeleteDialog.getDialogTitle()).to.eq('wlbApp.comment.delete.question');
