...
import { LabelGroupComponent } from 'app/entities/label-group/label-group.component';
...
describe('Component Tests', () => {
  describe('LabelGroup Management Component', () => {
    let comp: LabelGroupComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(LabelGroupComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.labelGroups && comp.labelGroups[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
