...
import { ProjectMemberComponent } from 'app/entities/project-member/project-member.component';
...
describe('Component Tests', () => {
  describe('ProjectMember Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.projectMembers && comp.projectMembers[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
