...
import { IssueActivityComponent } from 'app/entities/issue-activity/issue-activity.component';
...
describe('Component Tests', () => {
  describe('IssueActivity Management Component', () => {
    let comp: IssueActivityComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(IssueActivityComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.issueActivities && comp.issueActivities[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
