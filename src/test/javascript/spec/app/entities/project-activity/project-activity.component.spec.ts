...
import { ProjectActivityComponent } from 'app/entities/project-activity/project-activity.component';
...
describe('Component Tests', () => {
  describe('ProjectActivity Management Component', () => {
    let comp: ProjectActivityComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ProjectActivityComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.projectActivities && comp.projectActivities[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
