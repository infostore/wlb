...
describe('Service Tests', () => {
  describe('ProjectActivity Service', () => {
    ...
    let elemDefault: IProjectActivity;
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(ProjectActivityService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new ProjectActivity(0, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a ProjectActivity', () => {
        ...
        service.create(new ProjectActivity()).subscribe(resp => (expectedResult = resp.body));
