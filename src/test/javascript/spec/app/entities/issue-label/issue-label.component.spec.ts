...
import { IssueLabelComponent } from 'app/entities/issue-label/issue-label.component';
...
describe('Component Tests', () => {
  describe('IssueLabel Management Component', () => {
    let comp: IssueLabelComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(IssueLabelComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.issueLabels && comp.issueLabels[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
