...
public class IssueCriteria implements Serializable, Criteria {
    ...
    private LongFilter issueLabelId;

    private LongFilter issueAttachmentId;

    private LongFilter issueActivityId;
    ...
    public IssueCriteria(IssueCriteria other) {
        ...
        this.issueLabelId = other.issueLabelId == null ? null : other.issueLabelId.copy();
        this.issueAttachmentId = other.issueAttachmentId == null ? null : other.issueAttachmentId.copy();
        this.issueActivityId = other.issueActivityId == null ? null : other.issueActivityId.copy();
    ...
    public LongFilter getIssueLabelId() {
        return issueLabelId;
    }

    public void setIssueLabelId(LongFilter issueLabelId) {
        this.issueLabelId = issueLabelId;
    }

    public LongFilter getIssueAttachmentId() {
        return issueAttachmentId;
    }

    public void setIssueAttachmentId(LongFilter issueAttachmentId) {
        this.issueAttachmentId = issueAttachmentId;
    }

    public LongFilter getIssueActivityId() {
        return issueActivityId;
    }

    public void setIssueActivityId(LongFilter issueActivityId) {
    ...
    public boolean equals(Object o) {
        ...
        return
            ...
            Objects.equals(issueLabelId, that.issueLabelId) &&
            Objects.equals(issueAttachmentId, that.issueAttachmentId) &&
            Objects.equals(issueActivityId, that.issueActivityId) &&
    ...
    public String toString() {
        return "IssueCriteria{" +
                ...
                (issueLabelId != null ? "issueLabelId=" + issueLabelId + ", " : "") +
                (issueAttachmentId != null ? "issueAttachmentId=" + issueAttachmentId + ", " : "") +
                (issueActivityId != null ? "issueActivityId=" + issueActivityId + ", " : "") +
