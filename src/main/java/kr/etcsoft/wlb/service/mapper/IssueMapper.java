...
public interface IssueMapper extends EntityMapper<IssueDTO, Issue> {
    ...
    @Mapping(target = "issueAttachments", ignore = true)
    @Mapping(target = "removeIssueAttachment", ignore = true)
    @Mapping(target = "issueActivities", ignore = true)
    @Mapping(target = "removeIssueActivity", ignore = true)
