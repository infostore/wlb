...
@RestController
@RequestMapping("/api/wlb-kafka")
public class WlbKafkaResource {

    private final Logger log = LoggerFactory.getLogger(WlbKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public WlbKafkaResource(KafkaProperties kafkaProperties) {
