...
export class MilestoneComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.milestoneService
      ...
      .subscribe(
        (res: HttpResponse<IMilestone[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  registerChangeInMilestones(): void {
    this.eventSubscriber = this.eventManager.subscribe('milestoneListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IMilestone[] | null, headers: HttpHeaders, page: number): void {
